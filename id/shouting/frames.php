...
<html>
  ...
  <body class="la">
    <div class="lxx" style="width:100%;height:100%;">
      <div class="lxxx" style="width:100%;height:100%;display:flex;align-items:center;justify-content:space-around;">
        <span id="dfi" style="font-size:19px;">로드 중..</span>
      </div>
    </div>
